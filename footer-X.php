			...
			<div class="col-lg-3 col-md-6 ml-auto mb-5 mb-lg-0">
				...
				<ul class="list-inline">
					...
					<li class="mb-2">
						...
						<span class="popuptext" id="myPopup"><img class="alignnone size-full wp-image-343" src="https://triadchina.keyidev.com/wp-content/uploads/2020/04/wechat-qr.png" alt="" width="140" height="140" /></span>
						</div>
					</li>
					<li class="mb-2">
	...
	<section class="u-py-30 bg-gray-v5">
		<div class="container">
			<p class="mb-0 text-center">
				© 2020 Demo Keyiswift - Tous droits réservés			</p>
