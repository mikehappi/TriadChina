...
if ( ! function_exists( 'triadchina_setup' ) ) :
	...
	function triadchina_setup() {
		 ...
		 * If you're building a theme based on Triad China, use a find and replace
		...
		add_theme_support( 'custom-background', apply_filters( 'triadchina_custom_background_args', array(
 ...
 */
function triadchina_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'triadchina_content_width', 640 );
}
add_action( 'after_setup_theme', 'triadchina_content_width', 0 );
 ...
 */
function triadchina_widgets_init() {
...
add_action( 'widgets_init', 'triadchina_widgets_init' );
